...
import camHome from './src/components/camHome'
import friendMessage from './src/components/friendMessage'
...
const ConnectedCamHome = connect(mapStateToProps, mapDispatchToProps)(camHome);
const ConnectedfriendMessage = connect(mapStateToProps, mapDispatchToProps)(friendMessage);
...
const scenes = Actions.create(
    <Scene key='root'>
      ...
      <Scene 
          key="camHome"
          component={ConnectedCamHome}
          title="camHome"
      />
       <Scene 
          key="friendMessage"
          component={ConnectedfriendMessage}
          title="friendMessage"
      />
    </Scene>
...
AppRegistry.registerComponent('locMemo', () => RNFacebookFirebase);
